...
(cl:defmethod cl:initialize-instance :after ((m <SetLEDEffect-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLEDEffect-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetLEDEffect-request> is deprecated: use clover-srv:SetLEDEffect-request instead.")))

(cl:ensure-generic-function 'effect-val :lambda-list '(m))
(cl:defmethod effect-val ((m <SetLEDEffect-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clover-srv:effect-val is deprecated.  Use clover-srv:effect instead.")
  (effect m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <SetLEDEffect-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clover-srv:r-val is deprecated.  Use clover-srv:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <SetLEDEffect-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clover-srv:g-val is deprecated.  Use clover-srv:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <SetLEDEffect-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clover-srv:b-val is deprecated.  Use clover-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetLEDEffect-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLEDEffect-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetLEDEffect-response> is deprecated: use clover-srv:SetLEDEffect-response instead.")))
