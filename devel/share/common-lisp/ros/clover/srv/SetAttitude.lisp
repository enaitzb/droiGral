...
(cl:defmethod cl:initialize-instance :after ((m <SetAttitude-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAttitude-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetAttitude-request> is deprecated: use clover-srv:SetAttitude-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetAttitude-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAttitude-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetAttitude-response> is deprecated: use clover-srv:SetAttitude-response instead.")))
