...
(cl:defmethod cl:initialize-instance :after ((m <SetRates-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetRates-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetRates-request> is deprecated: use clover-srv:SetRates-request instead.")))
...
(cl:defmethod thrust-val ((m <SetRates-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clover-srv:thrust-val is deprecated.  Use clover-srv:thrust instead.")
  (thrust m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetRates-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetRates-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetRates-response> is deprecated: use clover-srv:SetRates-response instead.")))
