...
(cl:defmethod cl:initialize-instance :after ((m <SetVelocity-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVelocity-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetVelocity-request> is deprecated: use clover-srv:SetVelocity-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetVelocity-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVelocity-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetVelocity-response> is deprecated: use clover-srv:SetVelocity-response instead.")))
