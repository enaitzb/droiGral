...
(cl:defmethod cl:initialize-instance :after ((m <Navigate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navigate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<Navigate-request> is deprecated: use clover-srv:Navigate-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Navigate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navigate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<Navigate-response> is deprecated: use clover-srv:Navigate-response instead.")))
