...
(cl:defmethod cl:initialize-instance :after ((m <SetPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetPosition-request> is deprecated: use clover-srv:SetPosition-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<SetPosition-response> is deprecated: use clover-srv:SetPosition-response instead.")))
