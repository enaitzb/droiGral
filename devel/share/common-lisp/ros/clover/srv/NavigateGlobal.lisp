...
(cl:defmethod cl:initialize-instance :after ((m <NavigateGlobal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateGlobal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<NavigateGlobal-request> is deprecated: use clover-srv:NavigateGlobal-request instead.")))
...
(cl:defmethod speed-val ((m <NavigateGlobal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clover-srv:speed-val is deprecated.  Use clover-srv:speed instead.")
  (speed m))
...
(cl:defmethod auto_arm-val ((m <NavigateGlobal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clover-srv:auto_arm-val is deprecated.  Use clover-srv:auto_arm instead.")
  (auto_arm m))
...
(cl:defmethod cl:initialize-instance :after ((m <NavigateGlobal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateGlobal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clover-srv:<NavigateGlobal-response> is deprecated: use clover-srv:NavigateGlobal-response instead.")))
